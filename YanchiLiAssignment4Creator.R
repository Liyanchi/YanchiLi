...
##1
library(foreign)
flights <-read.csv("/Users/provence/Documents/flights.csv")
planes<-read.csv("/Users/provence/Documents/flights.csv")
weather<-read.csv("/Users/provence/Documents/weather.csv")
airports<-read.csv("/Users/provence/Documents/weather.csv")
...
##3 different ways to select the delay varaibles from flights
...
#116 observations. None NAs appear in the avg_arr_delay.
df.9d<- airports %>%
  full_join(dest_delay, by="dest")
#3378 observations. There're 3262 NAs in avg_arr_delay. Because quantity of rows of both tables are different.
